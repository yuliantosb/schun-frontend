    ...
    render() {
        return (
            ...
            <Row noGutters className="page-header py-4">
                    <PageTitle sm="4" title="Stock out" subtitle="Add new Stock out material" className="text-sm-left" />
                </Row>
                <Row>
                    <Col>
                        <Card small className="mb-4">
                            <CardHeader className="border-bottom">
                                <h6 className="m-0">Add new Stock out Material</h6>
                            </CardHeader>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="form-group">
                                                <label className="control-label">Stock out Date</label>
                                                <DatePicker
                                                    size="md"
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" placeholder="Unit of material" />
                                            </div>
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="custom-file mb-3">
                                                    <input type="file" className="custom-file-input" id="customFile2" onChange={this.handleChangeUpload} />
                                                    <label className="custom-file-label" htmlFor="customFile2" id="placeholderCustomFile2">{this.state.uploadFile}</label>
                                                </div>
                                            </div>
