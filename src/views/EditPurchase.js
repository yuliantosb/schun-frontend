...
import { getPurchase, updatePurchase } from '../store/actions/purchaseActions';
...
class EditPurchase extends React.Component {
	...
	handleSubmit = (e) => {
		e.preventDefault();
        this.props.updatePurchase(this.props.match.params.id, this.state);
    }
        ...
        if (nextProps !== this.props) {
            if (nextProps.data) {
                this.setState({
                    ...
                    subtotal: nextProps.data.subtotal ? nextProps.data.subtotal : '',
                    total: nextProps.data.total ? nextProps.data.total : '',
                    tax: nextProps.data.tax ? nextProps.data.tax : '',
                    discount: nextProps.data.discount ? nextProps.data.discount : '',
                    file: nextProps.data.file ? nextProps.data.file : '',
                    evidence: nextProps.data.evidence ? nextProps.data.evidence : '',
                    notes: nextProps.data.notes ? nextProps.data.notes : '',
                    percent: nextProps.data.percent ? nextProps.data.percent : '',
                    reference: nextProps.data.reference ? nextProps.data.reference : '',
                    supplier_id: nextProps.data.supplier_id ? nextProps.data.supplier_id : '',
                    supplier_name: nextProps.data.supplier_name ? nextProps.data.supplier_name : '',
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <input value={this.state.reference} type="text" id="reference" className={`form-control ${ error && error.data.errors.reference && 'is-invalid' }`} onChange={this.handleChange} placeholder="Unique Purchase Code eg: 1201001" />
                                                        { 
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <AsyncSelect  value={{ label: this.state.supplier_name, value: this.state.supplier_id }} menuContainerStyle={{'zIndex': 999}} isClearable={true} className={error && error.data.errors.supplier_id && 'is-invalid'} styles={customerStyles} loadOptions={supplierOptions} id="supplier_id" placeholder="Type to search" onChange={this.handleSelectSupplier} />
                                                        { 
                                                ...
                                                <div className="col-md-6">
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <AsyncSelect  value={{ label: this.state.user_name, value: this.state.user_id }} isClearable={true} className={error && error.data.errors.user_id && 'is-invalid'} styles={customerStyles} loadOptions={inChargeOptions} id="user_id" placeholder="Type to search" onChange={this.handleSelectInCharge} />
                                                        { 
...
const mapStateToProps = (state) => {
    return {
        ...
        carts: state.purchase.purchase.carts
    }
}
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        updatePurchase: (id, data) => dispatch(updatePurchase(id, data))
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(withToastManager(EditPurchase));
